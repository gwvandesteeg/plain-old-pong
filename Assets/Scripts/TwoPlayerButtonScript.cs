...
namespace PaddleGame {
	/**
	 * A handler for the Two Player game button
	 * 
	 * Here we configure the action to take when the Two Player Game button
	...
	public class TwoPlayerButtonScript : MonoBehaviour {
		 ...
		 * Two Player mode, and switches the game to the next Scene.
		 * 
		 */
		void Awake () {
			...
			myButton.onClick.AddListener (() => {
				...
				// tell the GameConfiguration to setup the game for two players
